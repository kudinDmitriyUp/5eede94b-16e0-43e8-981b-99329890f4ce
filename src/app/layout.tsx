...
export const metadata: Metadata = {
  title: "Ristorante Caffè Parnaso - Cucina Italiana a Roma Parioli",
  description: "Ristorante elegante nel cuore dei Parioli. Cucina italiana tradizionale, atmosfera raffinata. Aperto da martedì a domenica 7:00-1:00. Prenota ora.",
  keywords: "ristorante Roma, Parioli, cucina italiana, prenotazione tavolo, ristorante elegante Roma",
  openGraph: {
    title: "Ristorante Caffè Parnaso - Cucina Italiana Roma",
    description: "Esperienza culinaria unica nel cuore dei Parioli. Tradizione italiana e atmosfera elegante.",
    siteName: "Parnaso Roma",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763522309131-qhuga4ga.jpg",
        alt: "Ristorante Parnaso Roma"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",
    title: "Ristorante Caffè Parnaso - Roma",
    description: "Cucina italiana tradizionale nel prestigioso quartiere Parioli",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763522309131-qhuga4ga.jpg"]
  },
  robots: {
    index: true,
    follow: true
